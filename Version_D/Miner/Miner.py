...
def mine_meaningful_features(ppi: PrecomputedPopulationInformation,
    ...
    layers.append(MinerLayer.make_1_parameter_layer(ppi.search_space))
    ...
    scores = MeasurableCriterion.compute_scores_for_features(final_pfi, parameter_schedule[-1].criteria_and_weights)
